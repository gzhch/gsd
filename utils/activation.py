...
def sample_n(logits, return_probs: bool=False, do_sample: bool=False, top_k: int=50, top_p: float=0.9, temperature: float=0.2, n=1):
...
def case_study(models, tokenizer, input_ids, draft_config, max_new_tokens=100, early_stop=False):
    ...
    with torch.no_grad():
        ...
        while True:
            ...
            if is_leaf:
                generate_by[:, step+len(matched_token_index)] = 1
